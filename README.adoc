...
image::/demo/online.jpg[Online]

* **Room List**

image::/demo/room_list.jpg[Room List]
...
Hoặc bạn chỉ cần clone https://github.com/nghlong3004/boom-battle-backend[Boom Battle Backend^] và tải file `.jar` cho client tại https://github.com/nghlong3004/boom-battle-swing/blob/main/out/artifacts/boom_battle_swing_jar/boom-battle-swing.jar[đường dẫn này^].

**Hướng dẫn chạy:**

* **Server:** Tìm và chạy file `BoomBattleBackendApplication.java`.
* **Client:** Tìm và chạy file `BoomBattleSwing.java` hoặc mở terminal và gõ:
+
[source,bash]
----
cd out\artifacts\boom_battle_swing_jar
java -jar boom-battle-swing.jar
----
...
* **Protocol:** WebSocket (JSON payload).
