...
import static io.nghlong3004.constant.GameConstant.FPS;
...
public class GameLoop implements Runnable {
    ...
    private final double FRAMES_PER_NANO_TIME = SECOND / FPS;
    private final double UPDATE_PER_NANO_TIME = SECOND / UPS;
