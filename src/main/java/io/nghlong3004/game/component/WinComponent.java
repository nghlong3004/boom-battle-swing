...
public abstract class WinComponent extends GameComponent {
    ...
    public WinComponent(GameContext context) {
        super(context);
        loadImages();
        createSpritesButton();
    ...
    private void loadImages() {
        winImage = ImageLoader.loadImage(GAME_WIN);
    }
    ...
    public void render(Graphics g) {
        ...
        if (winImage != null) {
            ...
            if (starScale > 0.1f && imageAlpha > 0.5f) {
                drawStar(g2d, imageX - 40, imageY + scaledHeight / 2, starScale, starRotation,
                         new Color(255, 215, 0, (int) (imageAlpha * 200)));
                drawStar(g2d, imageX + scaledWidth + 20, imageY + scaledHeight / 2, starScale, -starRotation,
                         new Color(255, 215, 0, (int) (imageAlpha * 200)));
            }
        }
    ...
    private void drawStar(Graphics2D g2d, int x, int y, float scale, int rotation, Color color) {
        g2d.setColor(color);

        int scaledSize = (int) (20 * scale);
