...
public class ImageLoader {
    ...
    public static BufferedImage[][] loadTileSprites() {
        ...
        var sprites = new BufferedImage[4][5];
    ...
    private static void loadTile(BufferedImage[][] sprites, MapType row, TileType column) {
        String path = MapConstant.IMAGE_PATH_TEMPLATE.formatted(row.getAssetKey(), column.getAssetKey());
        sprites[row.id][column.id] = loadImage(path);
    }
